...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=GBK"></meta>
...
<script type="text/javascript">
	...
	<link href="CSS1/main.css" rel="stylesheet" type="text/css"></link>
	
</head>

<body style="background-image: url('images/BJ1.jpg');
background-attachment:fixed; ">
<a href="Postservlet?act=back"><h2>《《返回主页</h2></a>
<div id="header">
...
<div class="sidebar" style="background-color:rgba(255, 255, 255, 0.5);">
    ...
    <div class="side_list">
      <ul>
         ...
         <c:redirect url="Postservlet?act=showMRCB"></c:redirect>
         </c:if> 
                                                                <!-- 显示每日晨报 -->
         <c:forEach items="${sessionScope.MRCB}" var="go" >
         <li><h3><a href="Postservlet?act=click&p_id=${go.p_id }"><b>${go.p_title }</b></a></h3><br/>  </li>
         </c:forEach>
      </ul>
    </div>
    ...
    <div class="content">
      <ul class="classlist">
          ...
          <div class="d3" style=" width: 620px">
           ...
           <div class="d1" style="border:solid #907EFC;height: 80px; width: 50px; margin-top: 20px;"><img name="${postwriter.u_name }" alt="头像" src="${postwriter.u_photo }" style="height: 60px" width="50px" align="top" onmouseover="showpmsg(this)" onmouseout="hide(this)" />
  ...
  <div style=" width: 620px" >
       	   ...
       	   <br/>
          		 ...
          		 <c:forEach items="${sessionScope.userslist}" var="ul" >
                         ...
                         <img alt="头像" name="${ul.u_name }" src="${ul.u_photo }" style="height: 60px" width="50px" align="top" onmouseover="showpmsg(this)" onmouseout="hide(this)" /><br/>${ul.u_name }</div>
     ...
     <hr />
      <ul class="classlist">
        <form action="Postservlet?act=diss&p_id=${postdetail.get(0).p_id }" method="post" onsubmit="return checkComment()">
