...
<html>
	...
	<header id="gtco-header" class="gtco-cover" role="banner" style="background-image: url(images/BJ1.jpg)">
             ...
             <c:when test="${empty sessionScope.users}" >
					...
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">从这里，开启属于你们的精彩</span>
							<h1>校园论坛.</h1>	
						</div>
						...
						<div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight">
							<div class="form-wrap">
								<div class="tab">
									<ul class="tab-menu">
										<li class="active gtco-first"><a href="#" data-tab="signup">用户</a></li>
										<li class="gtco-second"><a href="#" data-tab="login">管理员</a></li>
									</ul>
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<form action="UserServlet?act=login" method="post">
												<div class="row form-group">
													<div class="col-md-12">
														<label for="username">Username or StudentNumber</label>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" class="btn btn-primary" value="Login登录">
													    <a href="Reg.jsp"><input type="button" class="btn btn-primary" value="Reg注册"></a>
													</div>
												</div>
											</form>	
										</div>
											...
											<form action="adminservlet?act=login" method="post">
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="text" class="form-control" id="username" name="adm">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
