...
<!-- jQuery -->
	...
	<div class="page-inner" style="background-color:rgba(255, 255, 255, 0.5);" id="BGI">
...
<div class="sidebar" style="background-color:rgba(255, 255, 255, 0.3);">
    ...
    <div class="side_list">
      <ul>
         ...
         <li><h5><a href="Postservlet?act=click&p_id=${go.p_id }"><b>${go.p_title }</b></a></h5>  </li>
         </c:forEach>
  ...
  <div class="main">
    ...
    <div class="content">
      <ul class="class_date">
       ...
       <a href="Postservlet?act=clicktype&t_id=${go.t_id }"><b >${go.t_type }</b></a>
         </c:forEach>
      ...
      <ul class="classlist">								<!-- 显示所有帖子 -->
             ...
             <li> <a href="Postservlet?act=click&p_id=${go.p_id }"><b>${go.p_title }</b></a> 
             <span> ${go.p_ntime }</span></li>
             <br>
             </c:forEach>
       ...
       <form action="Postservlet?act=posting" method="post">
               用户名：
    <c:choose>
    <c:when test="${empty sessionScope.users}" ><input style="background-color: #D2F2FE" id="cauthor" name="cauthor" value="请登录后发发帖!"></td></c:when>
    <c:otherwise> 
    <input style="background-color: #D2F2FE" id="cauthor" name="cauthor" value="${users }"></td>
    </c:otherwise>
    </c:choose>
    <br><br> 
              标&nbsp;&nbsp;&nbsp;题：&nbsp;<input type="text" style="background-color: #D2F2FE" name="p_title" cols="70" rows="10" value="请输入帖子标题" 
